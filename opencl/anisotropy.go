...
func AddCubicAnisotropy2(Beff, m *data.Slice, Msat, k1, k2, k3, c1, c2 MSlice, queue *cl.CommandQueue, events []*cl.Event) {
...
func AddUniaxialAnisotropy2(Beff, m *data.Slice, Msat, k1, k2, u MSlice, queue *cl.CommandQueue, events []*cl.Event) {
	util.Argument(Beff.Size() == m.Size())
...
func AddUniaxialAnisotropy(Beff, m *data.Slice, Msat, k1, u MSlice, queue *cl.CommandQueue, events []*cl.Event) {
	util.Argument(Beff.Size() == m.Size())
...
func AddVoltageControlledAnisotropy(Beff, m *data.Slice, Msat, vcmaCoeff, voltage, u MSlice, queue *cl.CommandQueue, events []*cl.Event) {
	util.Argument(Beff.Size() == m.Size())
