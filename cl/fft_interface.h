...
void vkfftSetFFTPlanBufferSizes(interfaceFFTPlan* plan) {
    ...
    plan->config->inputBufferStride[1]  = plan->config->inputBufferStride[0]*plan->config->size[1];
    plan->config->inputBufferStride[2]  = plan->config->inputBufferStride[1]*plan->config->size[2];
    plan->config->outputBufferStride[1] = plan->config->outputBufferStride[0]*plan->config->size[1];
    plan->config->outputBufferStride[2] = plan->config->outputBufferStride[1]*plan->config->size[2];
