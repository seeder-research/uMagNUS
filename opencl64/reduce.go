...
// copy back single double result from GPU and recycle buffer
...
// copy back double slice result from GPU and recycle buffer
func copybackSlice(buf unsafe.Pointer) []float64 {
